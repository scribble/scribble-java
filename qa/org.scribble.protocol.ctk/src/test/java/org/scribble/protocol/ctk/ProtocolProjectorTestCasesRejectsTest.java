...
public class ProtocolProjectorTestCasesRejectsTest {

    private String globalModelFile;
    private ProtocolContext context;
    private String projectedRole;

    public ProtocolProjectorTestCasesRejectsTest(String globalModelFile, ProtocolContext context, String projectedRole) {
