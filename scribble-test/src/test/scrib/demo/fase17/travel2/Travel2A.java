...
import demo.fase17.travel2.TravelAgent2.TravelAgent2.statechans.A.EndSocket;
import demo.fase17.travel2.TravelAgent2.TravelAgent2.statechans.A.TravelAgent2_A_1;
import demo.fase17.travel2.TravelAgent2.TravelAgent2.statechans.A.TravelAgent2_A_2_Cases;
	...
	private EndSocket run(TravelAgent2_A_2_Cases A2) throws Exception
	{
		...
		switch (A2.op)
		{
			...
			case accpt:   
				...
				return A2.receive(accpt).request(S, SocketChannelEndpoint::new, "localhost", 9999)
