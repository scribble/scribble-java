...
public class RPAntlrGDotMessageTransfer
{
	// Same as original
	...
	public static RPGDotMessageTransfer
			parseParamGDotMessageTransfer(AntlrToScribParser parser, CommonTree root, RPAstFactory af) throws ScribParserException
	{
