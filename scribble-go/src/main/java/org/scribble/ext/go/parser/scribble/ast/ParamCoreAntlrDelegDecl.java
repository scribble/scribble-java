...
public class ParamCoreAntlrDelegDecl
{
	...
	public static ParamCoreDelegDecl parseDelegDecl(AntlrToScribParser parser, CommonTree ct, AstFactory af)
	{
		...
		return ((ParamAstFactory) af).ParamCoreDelegDecl(ct, schema, extName, source, alias);
	}
}
