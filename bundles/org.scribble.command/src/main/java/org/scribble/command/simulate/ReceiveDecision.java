...
public class ReceiveDecision extends Event {

	public ReceiveDecision() {
	}

	@Override
	public Result validate(ProtocolMonitor monitor, MonitorContext context, Description protocol,
						Session conv) {
		return(monitor.receiveDecision(context, protocol, conv, m_role, m_decision));
	}
	...
	public String toString() {
		return("ReceiveDecision "+m_decision+" from "+m_role);
	}
