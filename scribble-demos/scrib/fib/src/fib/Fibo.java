...
import fib.Fib.Fibonacci.statechans.A.Fibonacci_A_1;
import fib.Fib.Fibonacci.statechans.B.EndSocket;
import fib.Fib.Fibonacci.statechans.B.Fibonacci_B_1;
import fib.Fib.Fibonacci.statechans.B.Fibonacci_B_1_Handler;
import fib.Fib.Fibonacci.statechans.B.Fibonacci_B_2;
...
class MyB extends Thread implements Fibonacci_B_1_Handler
{
	...
	public void run()
	{
		try (ScribServerSocket ss = new SocketChannelServer(8888);
				MPSTEndpoint<Fibonacci, B> se = new MPSTEndpoint<>(this.fib,
						Fibonacci.B, new ObjectStreamFormatter()))
		{
	...
	@Override
	public void receive(Fibonacci_B_2 s, fibonacci op, Buf<Integer> arg1)
	...
	@Override
	public void receive(EndSocket schan, end op)
			throws ScribRuntimeException, IOException, ClassNotFoundException
	{
...
class MyA extends Thread
{
	...
	public void run()
	{
		try (MPSTEndpoint<Fibonacci, A> se = new MPSTEndpoint<>(this.fib,
				Fibonacci.A, new ObjectStreamFormatter()))
		{
			se.request(Fibonacci.B, SocketChannelEndpoint::new, "localhost", 8888);
	...
	private fib.Fib.Fibonacci.statechans.A.EndSocket run(Fibonacci_A_1 s, int todo)
			throws Exception
	{
		return (todo > 0)
				? run(
