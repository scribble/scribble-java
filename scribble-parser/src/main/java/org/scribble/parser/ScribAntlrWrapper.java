...
{
	private final DelDecorator df;
	
	public ScribAntlrWrapper(DelDecorator df)
	{
		this.df = df;
	}
	...
	// Parse InputStream (from a Resource) into a (del decorated) Module
	public Module parse(InputStream is) throws ScribParserException
	{
		try
		{
			...
			this.df.decorate(mod);  // TODO: refactor as AstVisitor
			return mod;
		}
		catch (IOException e)
		{
