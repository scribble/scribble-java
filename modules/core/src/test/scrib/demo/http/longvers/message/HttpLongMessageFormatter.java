...
import demo.http.longvers.message.server.Date;
import demo.http.longvers.message.server.ETag;
import demo.http.longvers.message.server.HttpVersion;
import demo.http.longvers.message.server.LastModified;
import demo.http.longvers.message.server.Server;
import demo.http.longvers.message.server.StrictTransportSecurity;
import demo.http.longvers.message.server.Vary;
import demo.http.longvers.message.server.Via;
