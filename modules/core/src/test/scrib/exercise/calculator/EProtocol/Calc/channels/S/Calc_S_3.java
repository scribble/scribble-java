...
public final class Calc_S_3 extends org.scribble.net.scribsock.SendSocket<Calc, S> implements Select_S_C_result_int<Calc_S_1> {
	public static final Calc_S_3 cast = null;

	protected Calc_S_3(org.scribble.net.session.SessionEndpoint<Calc, S> se, boolean dummy) {
		super(se);
	}
