...
public final class Calc_C_2 extends org.scribble.net.scribsock.ReceiveSocket<Calc, C> implements Receive_C_S_result_int<Calc_C_1> {
	public static final Calc_C_2 cast = null;

	protected Calc_C_2(org.scribble.net.session.SessionEndpoint<Calc, C> se, boolean dummy) {
		super(se);
	}
	...
	public Calc_C_1 async(S role, result op, org.scribble.net.Buf<Calc_C_2_Future> arg) throws org.scribble.main.ScribbleRuntimeException {
		arg.val = new Calc_C_2_Future(super.getFuture(Calc.S));
		return new Calc_C_1(this.se, true);
	}
	...
	public Calc_C_1 async(S role, result op) throws org.scribble.main.ScribbleRuntimeException {
		return async(Calc.S, op, (org.scribble.net.Buf<Calc_C_2_Future>) this.se.gc);
	}
}