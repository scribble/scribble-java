...
public class LocalInterruptible extends Interruptible<Local> implements LocalInteractionNode
{
	//protected LocalInterruptible(ScopeNode scope, LocalProtocolBlock block, List<LocalInterrupt> interrs)
	protected LocalInterruptible(ScopeNode scope, ProtocolBlock<Local> block, List<LocalInterrupt> interrs)
	{
