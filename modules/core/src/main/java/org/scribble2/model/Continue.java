...
public abstract class Continue extends SimpleInteractionNode
{
	...
	protected Continue(SimpleKindedNameNode<RecursionVarKind> recvar)//, SimpleInteractionNodeContext sicontext, Env env)
	{
		this.recvar = recvar;
	}

	//protected abstract Continue reconstruct(RecursionVarNode recvar);//, SimpleInteractionNodeContext sicontext, Env env);
	protected abstract Continue reconstruct(SimpleKindedNameNode<RecursionVarKind> recvar);//, SimpleInteractionNodeContext sicontext, Env env);
