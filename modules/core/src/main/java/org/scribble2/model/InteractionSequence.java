...
public abstract class InteractionSequence<K extends ProtocolKind> extends ModelNodeBase
{
	...
	protected InteractionSequence(List<? extends InteractionNode<K>> actions)
	{
		this.actions = actions;
	}
	
	protected abstract InteractionSequence<K> reconstruct(List<? extends InteractionNode<K>> ins);
	
	@Override
	//public InteractionSequence visitChildren(NodeVisitor nv) throws ScribbleException
	public InteractionSequence<K> visitChildren(ModelVisitor nv) throws ScribbleException
	{
