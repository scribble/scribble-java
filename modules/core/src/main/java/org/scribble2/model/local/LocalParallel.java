...
public class LocalParallel extends Parallel<Local> implements CompoundLocalInteractionNode
{
	//public LocalParallel(List<LocalProtocolBlock> blocks)
	public LocalParallel(List<? extends ProtocolBlock<Local>> blocks)
	{
		super(blocks);
	}
	...
	protected LocalParallel reconstruct(List<? extends ProtocolBlock<Local>> blocks)
	{
