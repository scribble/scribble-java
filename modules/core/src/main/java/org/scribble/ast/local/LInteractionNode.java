...
public interface LInteractionNode extends InteractionNode<Local>, LNode
{
	...
	LInteractionNode merge(LInteractionNode ln) throws ScribbleException;  // Merge currently does "nothing"; validation takes direct non-deterministic interpretation -- purpose of syntactic merge is to convert non-det to "equivalent" safe det in certain sitations
