 ...
 *
 */
public class TraceTreeAdaptor implements org.antlr.runtime.tree.TreeAdaptor {
	
	private static final Logger LOG=Logger.getLogger(TraceTreeAdaptor.class.getName());

	private ParserContext _context=new DefaultParserContext();
    private ScribbleTraceParser _parser=null;
    
    /**
     * The constructor.
     */
	public TraceTreeAdaptor() {
	}
	...
	public Trace getTrace() {
		return (_context.peek() instanceof Trace ? (Trace)_context.peek() : null);
	}
     ...
     */
    public void setParser(ScribbleTraceParser parser) {
        _parser = parser;
    }
