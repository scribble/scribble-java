...
import org.scribble2.foo.ast.ArgumentInstantiationList;
import org.scribble2.foo.ast.Do;
import org.scribble2.foo.ast.RoleInstantiationList;
import org.scribble2.foo.ast.name.qualified.ProtocolNameNode;

public class GlobalDo extends Do implements GlobalInteraction
{
	public GlobalDo(Token t, RoleInstantiationList roleinstans, ArgumentInstantiationList arginstans, ProtocolNameNode proto)
	{
		//this(t, null, roleinstans, arginstans, proto, null, null);
		super(t, null, roleinstans, arginstans, proto);
	}
