...
public class Interrupt extends ScribbleASTBase//AbstractSimpleInteractionNode
{
	...
	protected Interrupt(Token t, RoleNode src, List<MessageNode> msgs)//, GlobalInterruptContext gicontext, Env env)
	{
		super(t);//, gicontext, env);
		this.src = src;
