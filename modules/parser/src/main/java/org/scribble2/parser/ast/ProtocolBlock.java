...
public abstract class ProtocolBlock<T extends InteractionSequence<? extends InteractionNode>> extends ScribbleASTBase //extends AbstractEnvDelegationNode
{
	...
	/*protected ProtocolBlock(CommonTree ct, T seq)
	{
		//this(ct, is, null);
		/*super(ct);
		this.seq = seq;*
	...
	protected ProtocolBlock(Token t, T seq)
	{
		//this(ct, is, null);
		super(t);
		this.seq = seq;
