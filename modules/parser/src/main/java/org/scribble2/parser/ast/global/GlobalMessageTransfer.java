...
import org.scribble2.parser.ast.MessageTransfer;
...
{
	public GlobalMessageTransfer(Token t, RoleNode src, MessageNode msg, List<RoleNode> dests)
	{
		//this(t, src, msg, dests, null, null);
		super(t, src, msg, dests);
	}
