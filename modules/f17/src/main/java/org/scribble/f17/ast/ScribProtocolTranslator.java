...
import org.scribble.f17.ast.global.GlobalTypeTranslator;
...
public class ScribProtocolTranslator
{
	...
	public F17GType parseAndCheck(MainContext maincon, GProtocolName simplename) throws ScribbleException, ScribParserException
	{
		...
		return new GlobalTypeTranslator().translate(job.getContext(), ((ModuleDel) main.del()).getModuleContext(), gpd);
	}
