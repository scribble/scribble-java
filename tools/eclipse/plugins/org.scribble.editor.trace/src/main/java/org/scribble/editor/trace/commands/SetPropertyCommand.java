...
public class SetPropertyCommand<MS,MT,T> extends AbstractCommand {
	...
	public SetPropertyCommand(Object focus, PropertyAccessor<MS,T> source, PropertyAccessor<MT,T> target,
							Runnable postChangeHook, Runnable postUndoHook) {
		super("SetProperty", focus, true, postChangeHook, postUndoHook);
