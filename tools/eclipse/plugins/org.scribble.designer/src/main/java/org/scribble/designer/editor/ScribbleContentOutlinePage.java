...
import org.scribble.model.ModelProperties;
...
public class ScribbleContentOutlinePage extends ContentOutlinePage {
    ...
    private org.scribble.model.Module _model=null;
    private org.scribble.designer.editor.outliner.ModelOutliner _outliner=null;
    ...
    public void selectionChanged(SelectionChangedEvent event) {
        ...
        if (selection.isEmpty()) {
            ...
            if (((IStructuredSelection) selection).getFirstElement()
                    instanceof org.scribble.model.ModelObject) {
                org.scribble.model.ModelObject mobj=
                        (org.scribble.model.ModelObject)
